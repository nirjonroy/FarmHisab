...
<div class="row g-3">
    <div class="col-md-6">
        <label for="name" class="form-label">{{ __('farms.farm_name') }}</label>
    ...
    <div class="col-md-6">
        <label for="code" class="form-label">{{ __('farms.farm_code') }}</label>
    ...
    <div class="col-md-6">
        <label for="phone" class="form-label">{{ __('farms.phone') }}</label>
    ...
    <div class="col-md-6">
        <label for="district" class="form-label">{{ __('farms.district') }}</label>
    ...
    <div class="col-md-6">
        <label for="upazila" class="form-label">{{ __('farms.upazila') }}</label>
    ...
    <div class="col-md-6">
        <label for="union_name" class="form-label">{{ __('farms.union') }}</label>
    ...
    <div class="col-12">
        <label for="address" class="form-label">{{ __('farms.address') }}</label>
    ...
    <div class="col-12">
        <label for="description" class="form-label">{{ __('farms.description') }}</label>
...
<div class="mt-4 d-flex gap-2">
    ...
    <a href="{{ route('farms.index') }}" class="btn btn-outline-secondary">{{ __('common.cancel') }}</a>
</div>
