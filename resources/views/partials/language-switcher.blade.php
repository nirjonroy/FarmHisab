...
<div class="dropdown app-dropdown">
    <button class="btn {{ $buttonClass ?? 'btn-outline-success' }} btn-sm dropdown-toggle" type="button" data-bs-toggle="dropdown" data-bs-boundary="viewport" data-bs-auto-close="outside" aria-expanded="false">
        <span class="d-none d-sm-inline">{{ __('common.language') }}:</span> {{ $localeNames[$currentLocale] ?? $currentLocale }}
    </button>
